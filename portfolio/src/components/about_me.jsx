                ...
                <div className="mt-24">
                    ...
                    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-6">
                        ...
                        <div className="bg-white shadow-lg rounded-2xl p-6 border-l-4 border-yellow-500 lg:col-span-3">
                            ...
                            <p className="text-gray-700">
                                I play badminton and have participated in tournaments in the past. I also used to volunteer by teaching the youngest
                                members of my club. Badminton teaches you to work independently as well as in a team —
                                a good reflection of how I work: both solo and collaborative environments suit me.
                            </p>
                        </div>
                        ...
                        <div className="bg-white shadow-lg rounded-2xl p-6 border-l-4 border-yellow-500 lg:col-span-2">
                            ...
                            <blockquote className="text-gray-700 italic text-lg border-l-4 pl-4 border-yellow-400 mt-4">
                         ...
                         <div className="bg-white shadow-lg rounded-2xl p-6 border-l-4 border-yellow-500 lg:col-span-2  ">
                            ...
                            className="w-full block px-6 py-3 bg-yellow-400 text-black text-center rounded-md font-semibold hover:bg-yellow-500 transition">
